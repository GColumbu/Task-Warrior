...
public class Runner extends Enemy{
    private final static int RUNNER_MAX_SPEED = 200;
    ...
    private Vector2 previosMovingVelocity;
    public Runner(int x, int y){
        super(x, y, RUNNER_MAX_SPEED, RUNNER_MAX_FORCE, RUNNER_HEALTH, RUNNER_DAMAGE);
        stateTimer = 0;
        currentState = State.WALKING;
        idleTextureRegion = new TextureRegion(new Texture("assets/minion/minion_idle.png")); //TODO: change with runner idle
        currentRegion = idleTextureRegion;
        walkingAnimation = new EnemyAnimation("assets/runner/runner_walk.png", 0.07f, 12);
        walkingDamageAnimation = new EnemyAnimation("assets/runner/runner_walk_dmg.png", 0.07f, 12);
        dyingAnimation = new EnemyAnimation("assets/runner/runner_death.png", 0.07f, 4);
    }
    @Override
